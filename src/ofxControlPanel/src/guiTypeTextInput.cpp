...
void guiTypeTextInput::saveSettings(string filename){

    printf("\naha\n");
}

void guiTypeTextInput::saveSettings(){
    //printf("\nYAAAAAAAAAAaaaaa!!\n");
    // this works
    ofxXmlSettings myXML;
    myXML.loadFile("network_settings.xml");
    myXML.setValue(name, valueText.textString);
    myXML.saveFile("network_settings.xml");
}

void guiTypeTextInput::loadSettings(string filename){
    ofxXmlSettings myXML;
    myXML.loadFile("network_settings.xml");
    setValueText(myXML.getValue(name, ""));
}

void guiTypeTextInput::reloadSettings(){
    ofxXmlSettings myXML;
    myXML.loadFile("network_settings.xml");
    setValueText(myXML.getValue(name, ""));
}
